...
<p align="center"><strong>GitHub:</strong> <a href="https://github.com/xianNeuro/narRaters">github.com/xianNeuro/narRaters</a> · <strong>PyPI:</strong> <a href="https://pypi.org/project/narraters/">v0.3.17</a></p>
...
<p align="center">
  ...
  ·
  <a href="https://pypi.org/project/narraters/">📦 v0.3.17</a>
  ·
...
<table>
  <tr>
    ...
    <td><strong>Download & open</strong><br>Get the <a href="https://github.com/xianNeuro/narRaters/archive/refs/tags/v0.3.17.zip">v0.3.17 ZIP</a>, unzip, and double-click <code>narRater.app</code> (macOS) or <code>narRaters_installer.bat</code> (Windows). Needs <a href="https://www.python.org/downloads/">Python 3.10+</a>.</td>
  </tr>
  <tr>
...
1. **[Download the ZIP (v0.3.17)](https://github.com/xianNeuro/narRaters/archive/refs/tags/v0.3.17.zip)** and unzip it — or on the [GitHub repo page](https://github.com/xianNeuro/narRaters) use green **Code ▾** → **Download ZIP** for the current `main` branch. You'll get **`narRaters-0.3.17`**, **`narRaters-main`**, or **`narRaters`** (if you used `git clone`).
...
> Li, X. (2026). *narRaters: Naturalistic narratives processing platform* (Version 0.3.17) [Computer software]. Zenodo. https://doi.org/10.5281/zenodo.20486080
...
> narRaters (Version 0.3.17) is available at https://doi.org/10.5281/zenodo.20486080.
