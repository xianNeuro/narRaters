...
# --- Launcher script --------------------------------------------------------
# Resolves the repo root by walking up from narRater.app, so it works as long
# as the bundle stays inside the project folder where install.sh lives.
